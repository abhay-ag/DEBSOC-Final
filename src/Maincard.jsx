...
function Maincard({icon, heading, desc}) {
  return (
    <div className='mt-5 md:mx-5 w-[100%] md:w-[25rem] box-border h-[16rem] rounded flex flex-col justify-center items-center bg-gradient-to-br from-indigo-400 via-gray-700 mt-8 to-gray-600 p-0.5'>
        <div className='w-full h-full mycol relative flex flex-col justify-center box-border p-5'>
            <img src={Border} alt="corner border" className='absolute right-0 md:right-[-0.3rem] opacity-30 top-[-0.3rem] z-0'/>
